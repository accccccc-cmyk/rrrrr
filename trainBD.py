...
if __name__ == "__main__":
    ...
    if args.database == 'KoNViD-1k':
        features_dir = 'CNN_features_KoNViD-1k/' #features_dir = 'CNN_features_KoNViD-1k/BD/'  # features dir
    ...
    for epoch in range(args.epochs):
        ...
        #     writer.add_figure('Pred vs. MOS', mos_scatter(y_val, y_pred), epoch)
        #     if args.test_ratio > 0 and not args.notest_during_training:
        ...
        time3 = time3[4:-5]
        print("{}:epoch{} lasts{:.4f} seconds".format(time3, epoch, time.time() - time2))
